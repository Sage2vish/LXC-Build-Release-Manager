...
- [x] Confirm the persistence destinations under `~/Library/Application Support/LXC-BRM/` and repository-local `build/logs/`.
...
- [x] Create `system-context.svg` with the user/developer, GitHub repository/API, local repository, LXC-BRM app boundary, persistence, logs, release output, and directional data flow.
