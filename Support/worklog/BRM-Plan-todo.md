...
**622 of 815 items done — 193 still pending (76%).**

| Area | Done | Pending | Status |
| --- | ---: | ---: | --- |
| The window, by region | 57 | 35 | In progress |
...
| **The window, by region — subtotal** | | **57** | **35** | **In progress** |
